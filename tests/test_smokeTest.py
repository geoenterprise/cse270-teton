...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.set_window_size(1341, 1039)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("falsy@gmail.com")
    elements = self.driver.find_elements(By.ID, "password")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "password").send_keys("TestFalse")
  ...
  def test_directoryPage(self):
    ...
    self.driver.set_window_size(1347, 1039)
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1310, 1039)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "bizname").send_keys("enterprises")
